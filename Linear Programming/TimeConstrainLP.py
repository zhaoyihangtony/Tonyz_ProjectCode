...
def linearRegressionTeam(filename,testfile):
    ...
    #w9=lm.coef_[8]
    #w8=lm.coef_[8]
    return w1,w2,w3,w4,w5,w6,w7,w8,w9,w10,w11,w12,w13,w14,w15,lm.intercept_,linearmodelpredict
...
def LogisticRegressionTeam(filename,testfile):
    ...
    #w9=lm.coef_[8]
    #w8=lm.coef_[8]
    return w1,w2,w3,w4,w5,w6,w7,w8,w9,w10,w11,w12,w13,w14,w15,w0,logisticmodelpredict
...
if __name__ == '__main__':
    ...
    w1,w2,w3,w4,w5,w6,w7,w8,w9,w10,w11,w12,w13,w14,w15,w0,linearPredict= linearRegressionTeam(traindata,testdata)
    
    lw1,lw2,lw3,lw4,lw5,lw6,lw7,lw8,lw9,lw10,lw11,lw12,lw13,lw14,lw15,lw0,LogisticPredict= LogisticRegressionTeam(traindata,testdata)
    #print(coef[0],coef[1])
    ...
    originalWinrate.to_csv(foldername+ 'Time/'+ '13-14_15-16prediction_15attrs.csv')

    '''
    result=open(foldername + 'Time/' + "TimeConstrainLinearAndLogicticRregressionWeight","w")

    result.write("weights are for the parameters in the below order:")
    result.write("\n\nLinear Weight:")
    result.write("\n\nw1 : Total_3PA:%f , w2 : Total_3PM:%f , w3 :Total_AST:%f , w4 :Total_BLK:%f , w5 :Total_DEF:%f ,\n w6 :Total_DREB:%f , w7 :Total_FGA:%f , w8 :Total_FGM:%f , w9 :Total_FTA:%f , w10 :Total_FTM:%f ,\n w11 :Total_OREB:%f , w12 :Total_PF:%f , w13 :Total_PTS:%f , w14 :Total_STL:%f , w15 :Total_TOV:%f ,\n w0 :%f" %(w1,w2,w3,w4,w5,w6,w7,w8,w9,w10,w11,w12,w13,w14,w15,w0))
    result.write("\n\nLogistic Weight:")
    result.write("\n\n\w1 : Total_3PA:%f , w2 : Total_3PM:%f , w3 :Total_AST:%f , w4 :Total_BLK:%f , w5 :Total_DEF:%f ,\n w6 :Total_DREB:%f , w7 :Total_FGA:%f , w8 :Total_FGM:%f , w9 :Total_FTA:%f , w10 :Total_FTM:%f ,\n w11 :Total_OREB:%f , w12 :Total_PF:%f , w13 :Total_PTS:%f , w14 :Total_STL:%f , w15 :Total_TOV:%f ,\n w0 :%f" %(lw1,lw2,lw3,lw4,lw5,lw6,lw7,lw8,lw9,lw10,lw11,lw12,lw13,lw14,lw15,lw0))
    ...
    winrate = w1*sum(S_3PA)+w2*sum(S_3PM)+w3*sum(S_AST)+w4*sum(S_BLK)+w5*sum(S_DEF)+w6*sum(S_DREB)+w7*sum(S_FGA)+w8*sum(S_FGM)+w9*sum(S_FTA)+w10*sum(S_FTM)+w11*sum(S_OREB)+w12*sum(S_PF)+w13*sum(S_PTS)+w14*sum(S_STL)+w15*sum(S_TOV)+w0
