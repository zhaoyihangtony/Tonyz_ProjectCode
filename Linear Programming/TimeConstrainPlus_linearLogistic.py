...
if __name__ == '__main__':
    ...
    w1,w2,w3,w4,w5,w6,w7,w8,w9,w10,w11,w12,w13,w14,w0,linearPredict= linearRegressionTeam(traindata,testdata)
    '''
    ...
    result=open(foldername + 'Time/' + "TimeConstrainPLus_RregressionWeight_14sttrs","w")
