...
perresult=open("pernewdefstrategylinear","w")
#defining constants
...
#defining lp problem
prob_max = pulp.LpProblem("playersrecommendStrategy3linmax", pulp.LpMaximize)
...
print "\nMaximum Objective function value:",pulp.value(prob_max.objective)
perresult.write("\nMaximum Objective function value: %f" % pulp.value(prob_max.objective))
...
#defining lp problem
prob_min = pulp.LpProblem("playersrecommendStrategy3linmin", pulp.LpMinimize)
...
print "\nMinimum Objective function value:",pulp.value(prob_min.objective)
perresult.write("\nMinimum Objective function value: %f" % pulp.value(prob_min.objective))
